export default function PrivacyPolicy() {
  return (
    <div className="text-start">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to YoGato.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to YoGato, accessible from{" "}
            <a
              href="https://yogato.netlify.app/"
      ...
      <ul>
        <li>By email: seva.leonov@hotmail.com</li>
      </ul>
    </div>
  );
}
